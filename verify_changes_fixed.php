...
// 1. Check Server model for getMissingRequiredFields method
...
if (file_exists($detailView)) {
    ...
    $hasMissingWarning = strpos($content, 'getMissingRequiredFields()') !== false;
...
if (file_exists($dashboardView)) {
    ...
    $hasMissingFieldsUsage = strpos($content, '$device->getMissingRequiredFields()') !== false;
