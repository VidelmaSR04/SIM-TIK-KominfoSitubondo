...
<main class="w-full max-w-md relative z-10">
    <div class="glass-card rounded-xl p-8 w-full relative overflow-hidden">
        ...
        <div class="flex flex-col items-center mb-8">
            ...
            <h1 class="font-headline-lg text-headline-lg text-center text-on-surface mb-2">Daftar Akun</h1>
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-6">
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    ...
                    <input class="w-full pl-10 pr-4 py-2 bg-surface-container-lowest border border-outline-variant rounded-lg font-body-md text-body-md text-on-surface focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary transition-shadow @error('name') border-red-500 @enderror"
                           id="name" type="text" name="name" value="{{ old('name') }}" required autofocus autocomplete="name" placeholder="Masukkan Nama Lengkap" />
                </div>
                @error('name')
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    ...
                    <input class="w-full pl-10 pr-4 py-2 bg-surface-container-lowest border border-outline-variant rounded-lg font-body-md text-body-md text-on-surface focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary transition-shadow @error('email') border-red-500 @enderror"
                           id="email" type="email" name="email" value="{{ old('email') }}" required autocomplete="username" placeholder="Masukkan Email" />
                </div>
                @error('email')
                    <p class="text-sm text-red-600">{{ $message }}</p>
                @enderror
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    <span class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-outline">lock</span>
                    <input class="w-full pl-10 pr-10 py-2 bg-surface-container-lowest border border-outline-variant rounded-lg font-body-md text-body-md text-on-surface focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary transition-shadow @error('password_confirmation') border-red-500 @enderror"
                           id="password_confirmation" type="password" name="password_confirmation" required autocomplete="current-password" placeholder="Masukkan Ulang Password" />
                </div>
